    ...
    <section class="footer">
      ...
      <div className="footer-info">
        <div className="footer-desc">
          TaxSarthi is your comprehensive tax companion, simplifying tax-related
          complexities for everyday individuals in India. Seamlessly navigate
          the intricate landscape of taxes with TaxSarthi's user-friendly
          platform.
        </div>
