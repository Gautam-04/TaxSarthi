      ...
      <div className="footer">
        <div className="container">
          <div className="row footer-top">
            ...
            <div className="col-lg-6 footer-info footer-icons">
              <a
                className="mail_icon"
          ...
          <div className="row footer-info">
            <div className="col-lg-3 footer-desc">
              <p style={{ fontFamily: "sans-serif" }}>
                TaxSarthi is your comprehensive tax companion, simplifying
                tax-related complexities for everyday individuals in India.
                Seamlessly navigate the intricate landscape of taxes with
                TaxSarthi's user-friendly platform.
              </p>
            </div>
            <div className="col-lg-9">
              <div className="row footer-info">
                <div className="odd-col footer-sections footer-resources">
                  <h3 className="section-title">
                    <a href="/">RESOURCES</a>
                  </h3>
                  <h5 className="footer-h5">
                    <a href="/">About Taxes</a>
                  </h5>
                  <h5 className="footer-h5">
                    <a href="/">Savings</a>
                  </h5>
                ...
                <div className="even-col footer-sections footer-company">
                  <h3 className="section-title">
                    <a href="/">COMPANY</a>
                  </h3>
                  <h5 className="footer-h5">
              ...
              <div className="row footer-info subscribe">
          ...
          <div className="footer-bottom row">
            ...
            <div className="footer-bottom-left">
              <p>
                ...
                Copyright ©TaxSarthi, Inc | All Rights Reserved
              </p>
            </div>
