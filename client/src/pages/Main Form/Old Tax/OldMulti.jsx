    ...
    const handleSubmit = async (e) => {
        ...
        if (isCheckboxChecked) {
            try {
                ...
                toast.success(
                    "Data is saved. You will be redirected in a few seconds"
                );
                navigate("/doc");
            } catch (err) {
    ...
    useEffect(() => {
        ...
        const calculateOldRegimeTax = (income) => {
            ...
            if (income >= TAX_REBATE.old) {
                OldtaxDetails.slab1 = calculateSlabTax(
                    Math.min(income, 250000),
                    0
                );
        ...
        const calculateNewRegimeTax = (income) => {
            ...
            if (income >= TAX_REBATE_NEW.new) {
                NewtaxDetails.slab1 = calculateSlabTax(
                    Math.min(income, 250000),
                    0
                );
        ...
        <section id='form-filling'>
                        ...
                        {step === steps.length && (
                            ...
                            >
                                ...
                                <Button
                                    ...
                                    disabled={
                                        isLoading &&
                                        (!isCheckboxChecked || isLimitCrossed)
                                    }
            ...
            <div>
                <button
                    ...
                    className='form_feedback_button'
                >
                    Feedback
                </button>
                <Feedback
